...
int	main(int argc, char **argv)
{
	...
	std::cout << "Time to process a range of " << p.size() << " elements with std::vector : "  << std::fixed << static_cast<double>(end_time_deque - start_time_deque)/CLOCKS_PER_SEC << "s" << std::endl;
